...
public class UsersControllerTests
{
    ...
    private readonly Mock<ILogger<ScimUsersController>> _mockLogger;
    private readonly ScimUsersController _controller;

    public UsersControllerTests()
    {
        _mockRepository = new Mock<IScimRepository>();
        _mockLogger = new Mock<ILogger<ScimUsersController>>();
        _controller = new ScimUsersController(_mockRepository.Object, _mockLogger.Object);
