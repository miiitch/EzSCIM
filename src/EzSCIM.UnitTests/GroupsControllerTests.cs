...
public class GroupsControllerTests
{
    ...
    private readonly Mock<ILogger<ScimGroupsController>> _mockLogger;
    private readonly ScimGroupsController _controller;

    public GroupsControllerTests()
    {
        _mockRepository = new Mock<IScimRepository>();
        _mockLogger = new Mock<ILogger<ScimGroupsController>>();
        _controller = new ScimGroupsController(_mockRepository.Object, _mockLogger.Object);
